...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // Corrigido (F4): Radix seta `data-state="open"/"closed"`, não os atributos
        // booleanos `data-open`/`data-closed` — sem isso a transição de entrada/saída
        // nunca disparava (aparecia/desaparecia sem animação). Ver mesmo comentário em tabs.tsx.
